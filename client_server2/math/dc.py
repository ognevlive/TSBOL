...
_sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_8 = Integer(8); _sage_const_16 = Integer(16)
...
def norm(v, N):
	...
	sum2 = _sage_const_0 
	for vi in coefs:
		sum1 += vi**_sage_const_2 
		sum2 += vi
	sum2 = _sage_const_1 /N * (sum2 ** _sage_const_2 )
	return (sum1 - sum2).n()
...
def Babai_CVP(Lattice, w):
	...
	v = vector(ZZ, [_sage_const_0 ]*len(L[_sage_const_0 ]))
