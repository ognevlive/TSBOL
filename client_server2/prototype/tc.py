...
_sage_const_2 = Integer(2); _sage_const_251 = Integer(251); _sage_const_128 = Integer(128); _sage_const_73 = Integer(73); _sage_const_71 = Integer(71); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_1024 = Integer(1024); _sage_const_6 = Integer(6); _sage_const_8 = Integer(8); _sage_const_8844 = Integer(8844)
...
class TCPHandler(socketserver.BaseRequestHandler):
	def handle(self):
		global TC
		self.data = self.request.recv(_sage_const_1024 ).strip()
		if len(self.data) < _sage_const_6 :
			print ("Invalid size of request's buffer")
		command, data = self.data[:_sage_const_8 ], self.data[_sage_const_8 :]
		print(command, data)
...
if __name__ == "__main__":
	HOST, PORT = "localhost", _sage_const_8844 
